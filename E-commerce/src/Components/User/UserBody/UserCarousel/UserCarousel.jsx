...
<div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div className="carousel-inner relative">
    <div className="carousel-item active" data-bs-interval="10000">
      <img src="./public/images/c-3.jpg" className="d-block w-100" alt="..."/>
      <div className="carousel-caption filter drop-shadow-{-6px 12px 22px #ffffff}  pt-5 d-none d-md-block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 my-auto">
        <h5 className='text-[#E0A94C] font-bold text-[35px]'>HOLIDAY COLLECTION
WINTER WONDERGLAM
FOR YOU & YOUR CREW!</h5>
        <button className='text-[#E0A94C] border-solid px-3 py-2 font-bold border-2 border-[#E0A94C] hover:bg-[#E0A94C] hover:text-gray-800 transition duration-700'>Explore</button>
      </div>
    </div>
    <div className="carousel-item relative" data-bs-interval="2000">
      <img src="./public/images/c-1.jpg" className="d-block w-100" alt="..."/>
      <div className="carousel-caption filte drop-shadow-xl pt-5 d-none d-md-block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 my-auto">
        <h5 className='text-rose-600 font-bold text-[35px]'>HOLIDAY COLLECTION
WINTER WONDERGLAM
FOR YOU & YOUR CREW!</h5>
{/* filter drop-shadow-{amount} */}
        <button className='text-rose-700  border-solid px-3 py-2 font-bold border-2 border-rose-500 hover:bg-rose-700 hover:text-white transition duration-700'>Explore</button>
      </div>
    </div>
    <div className="carousel-item relative">
      <img src="./public/images/c-2.jpg" className="d-block w-100" alt="..."/>
      <div className="carousel-caption pt-5 d-none d-md-block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 my-auto">
        <h5 className='text-white font-bold text-[35px]'>HOLIDAY COLLECTION
WINTER WONDERGLAM
FOR YOU & YOUR CREW!</h5>
        <button className='text-white border-solid px-3 py-2 font-bold border-2 border-white hover:bg-gray-800 hover:border-0 hover:text-[#E0A94C] transition duration-700'>Explore</button>
      </div>
    </div>
  </div>
