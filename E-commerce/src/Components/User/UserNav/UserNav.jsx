...
const UserNav = ({reload}) => {
    ...
    return (
        <>
            ...
            <nav className='fixed top-0 z-20 w-full border-b bg-white font-sans min-h-[60px] nav-bar'>
                <div className='flex flex-wrap items-center justify-between xl:px-10 px-4 py-3 relative lg:gap-y-2 gap-y-4 gap-x-4'>
                    ...
                    <div className=' flex gap-3 items-center max-lg:ml-auto lg:order-1'>
...

                        {
                            ...
                            </div>:<div><span className='ms-3'>{name}</span><button onClick={Logout} className='border-solid border-2 ms-2 py-1 px-2 hover:bg-black hover:text-white transition duration-700 rounded-lg'>Logout</button></div>
                        }
